...
import {TruncatedNumberComponent, ITruncatedNumberComponentProps} from './components';
...
export class TruncatedNumber implements ComponentFramework.StandardControl<IInputs, IOutputs> {
	 ...
	 */
    constructor() {
        this.getValuesFromContext = this.getValuesFromContext.bind(this);
    }
    ...
    public init(context: ComponentFramework.Context<IInputs>, notifyOutputChanged: () => void, state: ComponentFramework.Dictionary, container: HTMLDivElement) {
        ...
        const props: ITruncatedNumberComponentProps = {
            ...contextValues,
            numberUtility,
            notifyOutputChanged,
        };
